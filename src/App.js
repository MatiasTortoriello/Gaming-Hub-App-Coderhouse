...
//Lista de productos
const prodList = [
  {name:"Assassins Creed Odyssey", id:"001", developer:"Ubisoft", type:"RPG", platform:"PC, PS4, XBOX", price:"60", stock:"32", description:"Elige tu destino en Assassin's Creed® Odyssey. Pasa de la marginación a la gloria embarcándote en una odisea para descubrir los secretos de tu pasado y cambiar el destino de la antigua Grecia.",},
  {name:"Age Of Empires IV", id:"002", developer:"Microsoft Games", type:"Estrategia", platform:"PC", price:"30", stock:"28", description:"Uno de los juegos de estrategia en tiempo real más queridos vuelve a demostrar todo su esplendor con Age of Empires IV, donde serás la estrella de las épicas batallas históricas que moldearon el mundo que hoy conocemos.",},
  {name:"Call of Duty WWII", id:"003", developer:"Activision", type:"Acción", platform:"PC, PS4, XBOX", price:"50", stock:"15", description:"Call of Duty regresa a sus raíces con Call of Duty: WWII, una experiencia sobrecogedora que redefine la Segunda Guerra Mundial para toda una nueva generación de jugadores.",},
  {name:"Dark Souls III", id:"004", developer:"FromSoftware", type:"RPG", platform:"PC, PS4, XBOX", price:"30", stock:"18", description:"Dark Souls continúa redefiniendo los límites con el nuevo y ambicioso capítulo de esta serie revolucionaria, tan aclamada por la crítica. ¡Prepárate para sumergirte en la oscuridad!",},
  {name:"Dragon Age Inquisition", id:"005", developer:"Bioware", type:"RPG", platform:"PC, PS4, XBOX", price:"30", stock:"27", description:"En la batalla por salvar Thedas, todas las decisiones importan. Crea a tu héroe, elige sus habilidades y reúne a un equipo para erradicar el mal del reino.",},
  {name:"Fallout IV", id:"006", developer:"Bethesda", type:"RPG", platform:"PC, PS4, XBOX", price:"40", stock:"15", description:"Bethesda Game Studios, el galardonado creador de Fallout 3 y The Elder Scrolls V: Skyrim, os da la bienvenida al mundo de Fallout 4, su juego más ambicioso hasta la fecha y la siguiente generación de mundos abiertos.",},
  {name:"Grand Theft Auto V", id:"007", developer:"Rockstar Games", type:"Acción", platform:"PC, PS4", price:"30", stock:"22", description:"Cuando un joven estafador callejero, un ladrón de bancos retirado y un psicópata aterrador se ven involucrados con lo peor y más desquiciado del mundo criminal, del gobierno de los EE. UU. y de la industria del espectáculo, tendrán que llevar a cabo una serie de peligrosos golpes para sobrevivir en una ciudad implacable en la que no pueden confiar en nadie. Y mucho menos los unos en los otros.",},
  {name:"Mass Effect Andromeda", id:"008", developer:"Bioware", type:"RPG", platform:"PC, PS4, XBOX", price:"50", stock:"24", description:"Mass Effect™: Andromeda te lleva a la galaxia de Andrómeda, más allá de la Vía Láctea. Allí, encabezarás la lucha por un nuevo hogar en territorio hostil como pionero o pionera, liderando un grupo de exploradores con instrucción militar. Escribe el próximo capítulo en la historia de la humanidad: de tus decisiones dependerá su supervivencia.",},
  {name:"Metal Gear Solid V The Phantom Pain", id:"009", developer:"Konami", type:"Acción", platform:"PC, PS4, XBOX", price:"60", stock:"11", description:"METAL GEAR SOLID V: The Phantom Pain marca la entrada de la franquicia en una nueva era gracias a la innovadora tecnología de Fox Engine y ofrece a los jugadores una experiencia de juego de máximo nivel y libertad táctica para llevar a cabo misiones en mundo abierto.",},
  {name:"Red Dead Redemption II", id:"010", developer:"Rockstar Games", type:"Acción", platform:"PC, PS4, XBOX", price:"70", stock:"10", description:"América, 1899. Arthur Morgan y la banda de Van der Linde son forajidos en busca y captura. Mientras los agentes federales y los mejores cazarrecompensas de la nación les pisan los talones, la banda deberá abrirse camino por el abrupto territorio del corazón de América y sobrevivir a base de robos y peleas. Arthur deberá elegir entre sus propios ideales y la lealtad a la banda que lo vio crecer.",},
  {name:"The Witcher III The Wild Hunt", id:"011", developer:"CD Projekt", type:"RPG", platform:"PC, PS4, XBOX", price:"40", stock:"7", description:"The Witcher: Wild Hunt es un RPG de mundo abierto basado en la narrativa y ambientado en un universo de fantasía visualmente impresionante, repleto de decisiones significativas y consecuencias trascendentales. En The Witcher, te pones en la piel del cazador de monstruos profesional Geralt de Rivia, y tienes la tarea de encontrar a la niña de la profecía en un vasto mundo abierto repleto de ciudades de mercaderes, islas piratas, peligrosos pasos de montaña y cuevas olvidadas para explorar.",},
  {name:"XCOM 2", id:"012", developer:"Firaxis", type:"Estrategia", platform:"PC", price:"30", stock:"9", description:"La Tierra ha cambiado. Han pasado veinte años desde que los líderes mundiales se rindieran incondicionalmente ante las fuerzas alienígenas. XCOM, la última defensa del planeta, acabó destrozada y dispersa. Ahora, en XCOM 2, los alienígenas dominan la Tierra y construyen resplandecientes ciudades que prometen un futuro brillante para la humanidad mientras esconden siniestros planes y eliminan a todos los opositores a su nuevo orden.",},
]
