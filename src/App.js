...
//Lista de productos
const prodList = [
  {name:"Assassin's Creed Odyssey", id:"001", type:"RPG", price:"60", stock:"32", description:"Elige tu destino en Assassin's Creed® Odyssey. Pasa de la marginación a la gloria embarcándote en una odisea para descubrir los secretos de tu pasado y cambiar el destino de la antigua Grecia.",},
